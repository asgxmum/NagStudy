    ...
    useEffect(() => {
        ...
        intro.setOptions({
            steps: [
                ...
                {
                    element: ".tasks-top-panel",
                    intro: "<b>Brain Dump</b> is your to-do list. Tasks go into <b>Today</b> or <b>Backlog</b>.",
                    title: "Brain Dump",
                },
                {
                    element: ".tasks-gantt-panel",
                    intro: "The <b>Gantt timeline</b> shows your day hour by hour. Drag tasks from Today onto it to schedule them.",
        ...
        <section className="view active" id="view-tasks">
            ...
            <div className="tasks-layout">
                ...
                <div className="card tasks-top-panel">
                    ...
                    <div className="tasks-top-actions" ref={topActionsRef}>
